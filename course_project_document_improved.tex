...
\IfFileExists{screenshots/overview.png}{
  \begin{figure}[h]
    ...
    \caption{Преглед на каталога с активни контроли.}
  \end{figure}
}{\textit{(Добавете файл screenshots/overview.png, за да се вмъкне автоматично.)}}

\IfFileExists{screenshots/filter.png}{
  \begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{screenshots/filter.png}
    \caption{Филтър по жанр в действие.}
  \end{figure}
}{\textit{(Добавете файл screenshots/filter.png, за да се вмъкне автоматично.)}}
